...
public class RunnerProm {
	...
	public static void main(String[] args) {
		...
		CivilRegistry civilRegistry = new CivilRegistry(getCivilRegistryName(args));
		civilRegistry.weddingRegistration(citizenMale2, citizenFemale2, LocalDate.of(2020, 1, 1));

		civilRegistry.weddingRegistration(citizenMale1, citizenFemale1, LocalDate.of(2023, 2, 20));
		civilRegistry.weddingRegistration(citizenMale3, citizenFemale3, LocalDate.of(2023, 2, 20));

		civilRegistry.birthRegistration(humanChild1, citizenMale1, citizenFemale1, LocalDate.of(2023, 2, 20));
		civilRegistry.birthRegistration(humanChild2, citizenMale1, citizenFemale1, LocalDate.of(2023, 2, 20));
		civilRegistry.birthRegistration(humanChild3, citizenMale3, citizenFemale3, LocalDate.of(2023, 2, 20));

		civilRegistry.divorceRegistration(citizenMale2, citizenFemale2, LocalDate.of(2023, 2, 20));
